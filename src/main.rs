...
fn main() {
    ...
    let raw = raw
        .into_iter()
        .map(|r| old_struct::MetaData::from(r))
        .collect::<Vec<old_struct::MetaData>>();
        ...
        .map(|old| {
            ...
            let data = match old.data {
                ...
                old_struct::Data::Doc(doc) => new_struct::Data::Doc(new_struct::Doc {
                    ...
                    course: {
                        let course_names = match doc.course.name {
            ...
            new_struct::MetaData {
                id: old.id.clone(),
                url: format!("https://byrdocs.org/files/{}.{}", old.id, filetype.as_str())
                    .to_string(),
